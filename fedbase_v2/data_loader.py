...
class data_process:
    def __init__(self, path, time_t, test_ratio=0.3, data_preprocessing = 1, noise=True, noise_std = 3, split_method='random', local_bs=16):
        self.path = path
    ...
    def split_dataset(self, num_nodes):
        ...
        if self.split_method == 'random':
            ...
            # Divide the dataset into num_nodes approximately equal parts
        ...
        return train_splited, test_loader_global, max_values_each_partition, train_y_mean_splited, self.train_x_max, self.train_y_max
