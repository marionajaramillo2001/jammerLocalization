...
class Polynomial3(torch.nn.Module):
    def __init__(self,gamma=2,theta0=None):
        """
...
class Net_augmented(torch.nn.Module):
    def __init__(self,input_dim, layer_wid, nonlinearity,gamma=2,theta0=None,model_mode='both'):
        super().__init__()
        #super(Net, self).__init__()

        # build the pathloss model
        self.model_PL = Polynomial3(gamma,theta0)
...
class Net_augmented_gate(torch.nn.Module):
    def __init__(self,input_dim, layer_wid, nonlinearity,gamma=2,theta0=None,model_mode='both',num_experts=2):
        super().__init__()
        # build the pathloss model
        self.model_PL = Polynomial3(gamma,theta0)
