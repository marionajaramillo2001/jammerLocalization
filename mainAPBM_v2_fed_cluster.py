...
if __name__ == '__main__':
    ...
    for scenario in scenarios:
        if scenario == 'suburban_raytrace':
            path_without_posEstVar = os.path.join(current_path, 'datasets', 'RT33', 'obs_time_1')
            path_with_posEstVar = os.path.join(current_path, 'datasets', 'RT34', 'obs_time_1')
        elif scenario == 'pathloss':
            path_without_posEstVar = os.path.join(current_path, 'datasets', 'PL2')
            path_with_posEstVar = os.path.join(current_path, 'datasets', 'PL10')
